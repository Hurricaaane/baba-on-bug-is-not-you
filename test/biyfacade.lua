...
function BIY:runClear()
    --[[ Declared in Data/syntax ]]
    clear()
end

function BIY:runCode()
    --[[ Declared in Data/rules ]]
    code()
end

function BIY:runClearUnits()
    --[[ Declared in Data/syntax ]]
    clearunits()
end

function BIY:runInit(argsObj)
    --[[ Declared in Data/syntax]]
...
function BIY:runAddUnit(argsObj)
    --[[ Declared in Data/syntax]]
    addunit(argsObj.id)
end

function BIY:setDataChanges(value)
    --[[ Initialized globally through Data/changes or Data/load]]
    changes = value
end

function BIY:getDataFeatures()
    --[[ Initialized globally through Data/syntax]]
    return features
end

function BIY:setDataFeatures(value)
    --[[ Initialized globally through Data/syntax]]
    features = value
end

function BIY:getDataTileslist()
    --[[ Initialized globally through Data/values]]
    return tileslist
end

function BIY:customGetClassNameByTileName(requestedName)
    --[[ Initialized globally through Data/values]]
